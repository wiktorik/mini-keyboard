...
- Integrated SHT3x sensor for lab-grade accuracy.
- 0.96" SSD1306 OLED screen.
- Built using the ESP32 Super Mini form factor.

3.Tech Stack
-  ESP32-C3 Super Mini, SHT3x, SSD1306 OLED.
-  C++ / Arduino Framework.
-  KiCad for PCB, Fusion 360 for Case.
